...
const DEFAULT_IMAGES: DomeGalleryItem[] = [
  {
...
function buildItems(pool: (string | DomeGalleryItem)[], seg: number): GridItem[] {
  ...
  const normalizedImages: DomeGalleryItem[] = pool.map((image) => {
