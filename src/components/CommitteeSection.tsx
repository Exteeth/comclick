...
export const DEPARTMENT_LEADS: DepartmentLeadGroup[] = [
  ...
  },
  {
    id: "fast-response",
    nameTh: "ฝ่ายรถเร็ว",
    badge: "Fast Response & Courier",
    color: "#e06c3a",
    icon: Zap,
    head: {
      role: "หัวหน้าฝ่ายรถเร็ว",
      nameTh: "นายภานุวัฒน์ เดชเจริญ",
      nameEn: "MR. PHANUWAT DETCHAROEN",
      nickname: "พี่อาร์ท",
      year: "ชั้นปีที่ 3",
      faculty: "สาขาวิชาคอมพิวเตอร์ศึกษา",
      facultyEn: "Computer Education",
      studentId: "663020888-9",
      citizenId: "1-4099-08888-11-0",
    ...
    subHead: {
      ...
      nameTh: "นายกิตติศักดิ์ พลสว่าง",
      nameEn: "MR. KITTISAK PHONSAWANG",
      nickname: "พี่โอ๊ต",
      year: "ชั้นปีที่ 2",
      faculty: "สาขาวิชาคอมพิวเตอร์ศึกษา",
      facultyEn: "Computer Education",
      studentId: "673040999-0",
      citizenId: "1-4099-09999-22-1",
  ...
  },
  {
    ...
    badge: "ComKiddy & Recreation",
    color: "#eccb7d",
    icon: Sparkles,
    head: {
      role: "หัวหน้าฝ่ายคอมคิดตี้",
