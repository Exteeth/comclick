  ...
  const campScheduleDays = [
    {
      ...
      items: [
        { time: "08:00 – 14:30 น.", event: "เดินทางจากคณะศึกษาศาสตร์ มหาวิทยาลัยขอนแก่น สู่โรงเรียนโนนสูงพิทยาคาร อำเภอเมืองอุดรธานี จังหวัดอุดรธานี" },
        ...
        { time: "18:30 – 18:45 น.", event: "เดินทางกลับโรงเรียนโนนสูงพิทยาคาร" },
